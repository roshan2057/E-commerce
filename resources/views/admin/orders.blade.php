        ...
        <table class="w-full shadow-inner">
          <thead>
            <tr class="bg-gray-100">
              ...
              <th class="px-6 py-3 font-bold whitespace-nowrap">User</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="p-4 px-6 text-center whitespace-nowrap"><a href="{{$order->userid}}">Details</a></td>
              <td class="p-4 px-6 text-center whitespace-nowrap">Paid</td>
              <td class="p-4 px-6 text-center whitespace-nowrap"><a href="{{route('deleteorder',$order->id)}}">Delete</a></td>
              <td class="p-4 px-6 text-center whitespace-nowrap">
